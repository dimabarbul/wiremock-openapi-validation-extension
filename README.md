...
The extension is written dependent in WireMock standalone **3.8.0**. It might or might not work with other versions.
...
```groovy
dependencies {
    implementation 'io.github.dimabarbul:wiremock-openapi-validation-extension:1.0.0'
}
```
...
```bash
# download jars
wget https://repo1.maven.org/maven2/org/wiremock/wiremock-standalone/3.8.0/wiremock-standalone-3.8.0.jar
wget https://repo1.maven.org/maven2/io/github/dimabarbul/wiremock-openapi-validation-extension/1.0.0/wiremock-openapi-validation-extension-1.0.0.jar
# run with default file path
java -cp "wiremock-openapi-validation-extension-1.0.0.jar:wiremock-standalone-3.8.0.jar" \
  wiremock.Run

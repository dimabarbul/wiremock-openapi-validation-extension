...
The extension is written dependent in WireMock standalone **3.13.0**. It might or might not work with other versions.
...
```groovy
dependencies {
    implementation 'io.github.dimabarbul:wiremock-openapi-validation-extension:1.4.0'
}
```
...
wget https://repo1.maven.org/maven2/io/github/dimabarbul/wiremock-openapi-validation-extension/1.4.0/wiremock-openapi-validation-extension-1.21.0-jar-with-dependencies.jar
# run with default file path
java -cp "wiremock-openapi-validation-extension-1.4.0-jar-with-dependencies.jar:wiremock-standalone-3.13.0.jar" \
  wiremock.Run
...
java -cp "wiremock-openapi-validation-extension-1.4.0.jar:wiremock-standalone-3.13.0.jar" \
  -Dopenapi_validation_file_path=https://petstore3.swagger.io/api/v3/openapi.json \
